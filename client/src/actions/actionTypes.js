...
export const PUT_MAILER_ACTIONS = {
  PUT: 'MAILER:PUT',
  PUT_SUCCESS: 'MAILER:PUT:SUCCESS',
  PUT_FAILURE: 'MAILER:PUT:FAILURE'
};

export const CHANGE_RESULT_TYPE = {
  TOGGLE_TRUE: 'TOGGLE:TRUE',
  TOGGLE_FALSE: 'TOGGLE:FALSE'
};

export const SET_DATE_RANGE = {
  SET_START: 'SET:START',
  SET_END: 'SET:END'
};
